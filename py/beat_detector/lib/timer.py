...
class Timer:
    ...
    @staticmethod
    def format_time(seconds: float) -> Tuple[Union[int, None], Union[int, None], Union[float, None]]:
    ...
    @staticmethod
    def stringify_time(passed_time: Tuple[Union[int, None], Union[int, None], Union[float, None]]) -> str:
